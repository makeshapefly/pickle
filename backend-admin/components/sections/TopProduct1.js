...
export default function TopProduct1() {
    return (
        <>
                ...
                <div className="wg-table table-top-product">
                    <ul className="flex flex-column gap14">
                        ...
                        <li className="product-item">
                            ...
                            <div className="flex items-center justify-between flex-grow">
                                <div className="name">
                                    <Link href="/product-list" className="body-title-2">Pedigree
                                        Puppy Dry Dog...</Link>
                                    <div className="text-tiny mt-3">100 Items</div>
                                </div>
                                <div>
                        ...
                        <li className="product-item">
                            ...
                            <div className="flex items-center justify-between flex-grow">
                                <div className="name">
                                    <Link href="/product-list" className="body-title-2">Biscoito
                                        Premier Cookie...</Link>
                                    <div className="text-tiny mt-3">100 Items</div>
                                </div>
                                <div>
                        ...
                        <li className="product-item">
                            ...
                            <div className="flex items-center justify-between flex-grow">
                                <div className="name">
                                    <Link href="/product-list" className="body-title-2 mb-3">Pedigree Adult Dry Dog...</Link>
