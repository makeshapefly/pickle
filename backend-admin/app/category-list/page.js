...
export default function CategoryList() {
    ...
    return (
        <>
            ...
            <Layout breadcrumbTitleParent="Category" breadcrumbTitle="All category">
                <div className="wg-box">
                    <div className="flex items-center justify-between gap10 flex-wrap">
                        ...
                        <Link className="tf-button style-1 w208" href="/new-category"><i className="icon-plus" />Add new</Link>
                    </div>
                    <div className="wg-table table-all-category">
                        <ul className="table-title flex gap20 mb-14">
                            ...
                            <li>
                                <div className="body-title">Icon</div>
                            </li>
                            <li>
                        ...
                        <ul className="flex flex-column">
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Wet food</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Supplemental food</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                            <g clipPath="url(#clip0_2774_3720)">
                                                <mask id="mask0_2774_3720" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x={0} y={0} width={24} height={24}>
                                                    <path d="M23.6499 23.65V0.350071H0.35V23.65H23.6499Z" fill="white" stroke="white" strokeWidth="0.7" />
                                                </mask>
                                                <g mask="url(#mask0_2774_3720)">
                                                    <path d="M1.40625 19.6895H22.5938C23.1094 19.6895 23.5313 19.2676 23.5313 18.752C23.5313 18.2363 23.1094 17.8145 22.5938 17.8145H1.40625C0.890624 17.8145 0.46875 18.2363 0.46875 18.752C0.46875 19.2676 0.890624 19.6895 1.40625 19.6895Z" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M1.40625 17.8145V14.6109C1.4062 14.4314 1.44427 14.2539 1.51092 14.0875L2.28379 12.1554C2.46375 11.5835 2.99812 11.1688 3.62938 11.1688H20.3707C20.9459 11.169 21.4627 11.5225 21.6765 12.0558L22.4505 13.9911C22.545 14.184 22.594 14.3961 22.5938 14.6109V17.8145" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M8.78945 14.4916C8.78945 14.5757 8.74932 14.636 8.70409 14.7193C8.62052 14.8733 8.57688 15.0458 8.57715 15.2211C8.57715 15.803 9.04885 16.2747 9.63071 16.2747C10.1414 16.2747 10.5672 15.9114 10.6638 15.4291H13.3361C13.4313 15.9114 13.8503 16.2747 14.3694 16.2747C14.942 16.2747 15.423 15.803 15.423 15.2211C15.4232 15.0458 15.3796 14.8733 15.2961 14.7193C15.2509 14.636 15.2106 14.5756 15.2106 14.4916C15.2106 14.4076 15.2509 14.3473 15.2961 14.264C15.3796 14.11 15.4232 13.9375 15.423 13.7622C15.423 13.1803 14.942 12.7086 14.3694 12.7086C13.8503 12.7086 13.4313 13.0719 13.3361 13.5541H10.6638C10.5672 13.0719 10.1414 12.7086 9.63071 12.7086C9.04885 12.7086 8.57715 13.1803 8.57715 13.7622C8.57715 13.9439 8.62313 14.1148 8.70409 14.264C8.74932 14.3473 8.78945 14.4076 8.78945 14.4916Z" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M4.37177 11.1274C4.09361 10.6411 4.03544 10.0358 4.26648 9.47801C4.50405 8.9044 4.99361 8.51145 5.55376 8.37415C5.46629 7.80411 5.64193 7.20148 6.08101 6.76241C6.52004 6.32333 7.12271 6.14769 7.69276 6.23516C7.83005 5.67505 8.22296 5.18549 8.79661 4.94783C9.37031 4.71023 9.99426 4.77857 10.4875 5.07754C10.8287 4.61259 11.379 4.31071 11.9999 4.31071C12.6209 4.31066 13.1712 4.61263 13.5124 5.07758C14.0056 4.77862 14.6296 4.71027 15.2033 4.94788C15.777 5.18549 16.1698 5.675 16.3071 6.23516C16.8772 6.14769 17.4799 6.32333 17.9189 6.76241C18.358 7.20148 18.5336 7.80411 18.4462 8.37415C19.0063 8.51145 19.4958 8.9044 19.7335 9.47806C19.9638 10.0341 19.9066 10.6374 19.6307 11.123" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M8.57788 8.01758H8.57826" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M11.6716 8.7207H11.672" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M14.3435 7.0332H14.3439" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M16.3591 9.00195H16.3595" stroke="#111111" strokeWidth="0.7" strokeMiterlimit="22.926" strokeLinecap="round" strokeLinejoin="round" />
                                                </g>
                                            </g>
                                            <defs>
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Food for adult dogs</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                            <g clipPath="url(#clip0_2774_3783)">
                                                ...
                                                <path d="M8.87427 16.5317C9.65092 16.5317 10.2805 15.9021 10.2805 15.1255C10.2805 14.3488 9.65092 13.7192 8.87427 13.7192C8.09762 13.7192 7.46802 14.3488 7.46802 15.1255C7.46802 15.9021 8.09762 16.5317 8.87427 16.5317Z" stroke="#111111" strokeWidth="0.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M10.0921 15.8286C9.84889 15.4084 9.39486 15.1255 8.87441 15.1255C8.35396 15.1255 7.89993 15.4084 7.65674 15.8286" stroke="#111111" strokeWidth="0.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M15.1257 10.2805C15.9024 10.2805 16.532 9.65092 16.532 8.87427C16.532 8.09762 15.9024 7.46802 15.1257 7.46802C14.3491 7.46802 13.7195 8.09762 13.7195 8.87427C13.7195 9.65092 14.3491 10.2805 15.1257 10.2805Z" stroke="#111111" strokeWidth="0.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M16.3433 9.57739C16.1001 9.15721 15.6461 8.87427 15.1256 8.87427C14.6052 8.87427 14.1511 9.15721 13.908 9.57739" stroke="#111111" strokeWidth="0.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M15.6582 4.57031C16.0465 4.57031 16.3613 4.25551 16.3613 3.86719C16.3613 3.47886 16.0465 3.16406 15.6582 3.16406C15.2699 3.16406 14.9551 3.47886 14.9551 3.86719C14.9551 4.25551 15.2699 4.57031 15.6582 4.57031Z" stroke="#111111" strokeWidth="0.7" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Kitten food</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                            <g clipPath="url(#clip0_2774_2556)">
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Food for adult cats</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                            <g clipPath="url(#clip0_2774_3907)">
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Food for elderly cats</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                            ...
                            <li className="product-item gap14">
                                ...
                                <div className="flex items-center justify-between gap20 flex-grow">
                                    <div className="name">
                                        <Link href="/product-list" className="body-title-2">Special pet food</Link>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
